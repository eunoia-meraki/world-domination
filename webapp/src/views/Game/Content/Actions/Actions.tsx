  ...
  >
    <Stack spacing={2}>
      ...
      >
        ...
        <Typography>
          Постройка щита стоит 300 у.е. Щит может защитить только от одного ядерного удара. После
          удара щит разрушается. Одновременно два щита над одним городом построить нельзя. Впишите
          названия ваших городов, которые вы хотите защитить.
        </Typography>
        <TextField
          id="answer"
          name="answer"
      ...
      >
        ...
        <Typography>
          Производить ядерные бомбы можно только при условии, что вы обладаете ядерной технологией.
          Производство каждой бомбы обойдется вам в 150 у.е. Вы можете производить не более трех
          бомб за раунд. Сколько бомб вы хотите произвести?
        </Typography>
        <RadioGroup
      ...
      >
        ...
        <Typography>
          Вы можете наносить ядерные удары, если у вас есть в наличии ядерные бомбы. За один ход вы
          можете нанести не более одного удара по одному городу. Если город не защищен щитом, он
          будет уничтожен. Впишите названия городов, по которым вы хотите нанести удар.
        </Typography>
        <TextField
          id="answer"
          name="answer"
